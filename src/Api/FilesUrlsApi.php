...
class FilesUrlsApi
{
     ...
     * @return \Softonic\DownloadApiSdk\Model\FileUrl[]
     ...
     * @param string $extra Associative array of parameters serialized and encoded in base64 (optional)
     * @param int $best Flag to get the best url instead of the whole list (optional)
     * @return Array of \Softonic\DownloadApiSdk\Model\FileUrl[], HTTP status code, HTTP response headers (array of strings)
     * @throws \Softonic\DownloadApiSdk\ApiException on non-2xx response
     */
    public function findFileUrlWithHttpInfo($id_files, $country, $extra = null, $best = null)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Softonic\DownloadApiSdk\Model\FileUrl[]',
                '/files/{id_files}/urls'
            );

            return array($this->apiClient->getSerializer()->deserialize($response, '\Softonic\DownloadApiSdk\Model\FileUrl[]', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Softonic\DownloadApiSdk\Model\FileUrl[]', $e->getResponseHeaders());
