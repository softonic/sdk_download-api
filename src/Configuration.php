...
class Configuration
{
     ...
     *
     * @var \Softonic\DownloadApiSdk\ApiClient
     */
     ...
     * @var string
     */
    protected $host = 'https://download.sftapi.com';
     ...
     * @var string
     */
    protected $userAgent = "Swagger-Codegen/v2.0.96/php";
    ...
    {
        $report  = 'PHP SDK (Softonic\DownloadApiSdk) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . phpversion() . PHP_EOL;
        $report .= '    OpenAPI Spec Version: 2.0.96-38' . PHP_EOL;
        $report .= '    SDK Package Version: v2.0.96' . PHP_EOL;
