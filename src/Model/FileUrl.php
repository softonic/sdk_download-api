...
namespace Softonic\DownloadApiSdk\Model;
...
class FileUrl implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = array("amazons3", "cloudfront", "leaseweb");
        ...
        $allowed_values = array("program_private", "program_private_staging", "program_private_integration", "program_private_development", "images_public", "images_public_staging", "images_public_integration", "images_public_development", "rpm_protected");
    ...
    public function setIdCdn($id_cdn)
    {
        ...
        if (!in_array($id_cdn, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'id_cdn', must be one of 'amazons3', 'cloudfront', 'leaseweb'");
        }
    ...
    public function setCdnDestination($cdn_destination)
    {
        ...
        if (!in_array($cdn_destination, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'cdn_destination', must be one of 'program_private', 'program_private_staging', 'program_private_integration', 'program_private_development', 'images_public', 'images_public_staging', 'images_public_integration', 'images_public_development', 'rpm_protected'");
        }
