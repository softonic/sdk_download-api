...
class FilesApi
{
    ...
    public function __construct(\Softonic\DownloadApiSdk\ApiClient $apiClient = null)
    {
        if ($apiClient == null) {
            ...
            $apiClient->getConfig()->setHost('http://download.priv.sftapi.com');
        }
    ...
    public function readFileWithHttpInfo($id_files, $country, $extra = null)
    {
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\Softonic\DownloadApiSdk\Client\Model\File', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Softonic\DownloadApiSdk\Client\Model\File', $e->getResponseHeaders());
