...
class FilesApi
{
     ...
     * @return \Softonic\DownloadApiSdk\Client\Model\File
     */
     ...
     * @throws \Softonic\DownloadApiSdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Softonic\DownloadApiSdk\Client\Model\File, HTTP status code, HTTP response headers (array of strings)
     */
    public function readFileWithHttpInfo($id_files, $country, $extra = null)
    {
        $returnType = '\Softonic\DownloadApiSdk\Client\Model\File';
        $request = $this->readFileRequest($id_files, $country, $extra);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Softonic\DownloadApiSdk\Client\Model\File',
     ...
     */
    public function readFileAsync($id_files, $country, $extra = null)
    {
        return $this->readFileAsyncWithHttpInfo($id_files, $country, $extra)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function readFileAsyncWithHttpInfo($id_files, $country, $extra = null)
    {
        $returnType = '\Softonic\DownloadApiSdk\Client\Model\File';
        $request = $this->readFileRequest($id_files, $country, $extra);
     ...
     */
    protected function readFileRequest($id_files, $country, $extra = null)
    {
        ...
        if ($country === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $country when calling readFile'
            );
        }
        if (strlen($country) > 2) {
